...
<body>
    ...
    <div class="sidebar clearfix">
        ...
        <ul class="sidebar-panel nav">
            ...
            <li><a href="{{ asset('/b_home') }}"><span class="icon color5"><i class="fa fa-home"></i></span>Home<span
                        class="label label-default">2</span></a></li>
            <li><a href="mailbox.html"><span class="icon color6"><i class="fa fa-envelope-o"></i></span>About Us<span
                        class="label label-default">19</span></a></li>
            <li><a href="mailbox.html"><span class="icon color6"><i class="fa fa-envelope-o"></i></span>Partner<span
                        class="label label-default">19</span></a></li>
            <li><a href="mailbox.html"><span class="icon color6"><i class="fa fa-envelope-o"></i></span>Our
                    Services<span class="label label-default">19</span></a></li>
